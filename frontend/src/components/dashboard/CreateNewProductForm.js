    ...
    <Fragment>
          ...
          ref={register({
             ...
             pattern:{
              ...
              message:'*It requires a value and unit'
             }
          })}
          />
...
export function ProductPriceInput({register,errors,defaultValue}){
 ...
 export function ImageUploader({register,errors,isNotRequired}){
  ...
  return(
    <Fragment>
      {errors.productImg && <ErrorMessage  role="alert">*The field is required</ErrorMessage>}
...
export function FormButtons(){
    return(
          <ButtonsWrapper >
<LoadButton as="input" type="submit" value="Submit"/>
