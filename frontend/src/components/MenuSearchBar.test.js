...
render(<MenuSearchBar setSearch={setSearch}
 />)
   ...
   expect(screen.getByRole('searchbox').placeholder).toEqual('Look for...')
...
render(<MenuSearchBar setSearch={setSearch}
 placeholder='To look for orderID...'/>)

   expect(screen.getByRole('searchbox').placeholder).toEqual('To look for orderID...')
