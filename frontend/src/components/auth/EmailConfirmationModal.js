...
<Page>
  <MessageCard>
    ...
    <p>In order to manage your account in the application it is necessary to verify your email. By pressing the following button, a message will be sent to your email with a verification link valid for 24 hours.</p>
