...
<UserPasswordInput  register={register} errors={errors} placeholder='New Password...'/>
<UserPasswordInput  register={register} errors={errors} name='confirmPassword' placeholder='Confirm password...'/>
