...
export default function SingupForm(){
  ...
  return(
    <FormCard>
     ...
     <UserPasswordInput   errors={errors} register={register} placeholder="Your password..."  />


         <ErrorServerMessage>{serverError}</ErrorServerMessage>

 
           <FormLink to= "/authentication/login" >Do you already have an account? <b>Login</b> </FormLink>
