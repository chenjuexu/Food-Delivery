...
<UserEmailInput  errors={errors} register={register} name="userEmail" />
    <UserPasswordInput name="userPassword" placeholder="Your password..."  errors={errors} register={register}/>
         ...
         <ErrorServerMessage>{serverError}</ErrorServerMessage>
            ...
            <FormLink to="/authentication/singUp" >You still do not have an account? <b>Sing Up</b> </FormLink>
            <FormLink as='a' onClick={() => setIsModalOpened(true)}>Did you forget your password?</FormLink>
